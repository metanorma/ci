...
# Strips whitespace-only differences + trailing whitespace + the entire
# leading comment block. The "Auto-generated by Cimas" banner is added by
# cimas sync, and template header comments have been reworded over time —
# consumers synced from older wordings carry longer/shorter comment
# blocks. Comments are non-semantic; (e.2) cares about behavioural drift
# only (the 2026-08-19 report carried 24 false positives from comment
# rewording before this widened from {0,3} to *).
CIMAS_BANNER_RE = /\A(?:#[^\n]*\n)*/
